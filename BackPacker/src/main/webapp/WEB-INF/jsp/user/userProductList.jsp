	...
	<div class="wrap">
			<div class="board-wrap">
				<dl class="community">
					<dt>
						...
						<div class="board_search">
							<div class="select floatl">
								<label for="board_selec">제목</label>
								<select id="board_selec">
									<option value="f_title" <%if(board_selec.equals("f_title")){ %> selected="selected" <%} %>>제목</option>
									<option value="f_content" <%if(board_selec.equals("f_content")){ %> selected="selected" <%} %>>내용</option>
								</select>
							</div>
					...
					<dd class="alignr"><input type="button" class="bt_ok" value="글쓰기" style="display: none;"/></dd><!-- 관리자만 보이는 버튼 -->
				</dl>
			</div>
		</div>
